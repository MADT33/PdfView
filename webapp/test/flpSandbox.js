		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Resumen Tarjeta",
									"targetURL": "#ypfzz1com512freelm4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ypfzz1com512freelm4-display": {
								"semanticObject": "ypfzz1com512freelm4",
								"action": "display",
								"description": "Resumen Tarjet",
								"title": "Resumen Tarjeta",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ypf.zz1com512freelm4",
									"url": sap.ui.require.toUrl("ypf/zz1com512freelm4")
								}
							}
						}
					}
